...
if mn > price or mn > pr_fp:
    if price < pr_fp :
        ...
        msz = "Amazon will give you Less Price !! for Samsung M 30"
        server.sendmail("akhandparadi146@gmail.com", "your email", msz)
    else:
        m2 = "Amazon will give you Less Price !! for Samsung M 30"
        server.sendmail("akhandparadi146@gmail.com", "", m2)
        hr = ToastNotifier()
